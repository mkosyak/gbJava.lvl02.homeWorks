...
public class Human implements Subjects, Runnable, LJumpable, HJumpable {
    public static final String objType = "Human";
    ...
    public Human(String actName) {
        objName = actName;
        System.out.printf("%n:> Participant %s (type %s) is assigning with the *DFT characters:", objName, objType);
        initMaxValues(maxRunDist, maxJumpHeight, maxJumpDist);
    }

    public Human(String actName, float run, float hJump, float lJump) {
        objName = actName;
